...
public class MonsterViewFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        battleButton.setOnClickListener(v -> monsterViewModel.onClickEvent(new Event(EventCode.BATTLE)));
        ...
        monsterViewModel.getButtonStatesLiveData().observe(getViewLifecycleOwner(), newButtonStates -> {
            ...
            feedButton.setEnabled(Boolean.TRUE.equals(newButtonStates.get(EventCode.FEED)));
            toiletButton.setEnabled(Boolean.TRUE.equals(newButtonStates.get(EventCode.TOILET)));
            cureButton.setEnabled(Boolean.TRUE.equals(newButtonStates.get(EventCode.CURE)));
            battleButton.setEnabled(Boolean.TRUE.equals(newButtonStates.get(EventCode.BATTLE)));
            resetButton.setEnabled(Boolean.TRUE.equals(newButtonStates.get(EventCode.RESET)));
        });
    }
}