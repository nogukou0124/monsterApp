package com.example.monsterapp.model.data.room;
...
import com.example.monsterapp.model.data.room.TypeConverters.StateCodeConverter;
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriteExecutor.execute(() -> {
                try {
                    ...
                    Monster monster = new Monster(1, StateCode.NORMAL, "アグモン", 6, 6, 3);
                ...
                try {
                    ...
                    if (database != null) {
                        ...
                        if (dao.getByUid(1) == null) {
                            dao.insert(new Monster(1, StateCode.NORMAL, "アグモン", 6,  6,3));
